...
export default function PlaygroundPage() {
  ...
  const [drawerEntry, setDrawerEntry] = useState<ExperienceEntry | null>(null);
      ...
      <div className="mx-auto max-w-6xl space-y-12">
        <header className="space-y-3 text-center">
          <p className="text-xs uppercase tracking-[0.2em] text-text-secondary">
            Component playground — visual regression matrix
          </p>
          ...
          <p className="text-base text-text-secondary leading-relaxed mx-auto max-w-xl">
            Isolated demo of every primitive (SearchBar, ActiveFilterChips,
            StatsBar, ExperienceCard, TagPill). Drives mock entries so
            component states stay visible even with empty data.
          </p>
        </header>
        ...
        >
          ...
          <StatsBar entries={MOCK_ENTRIES} activeSlugs={activeSlugs} />
        ...
        <p className="text-center text-xs text-text-muted">
          The real Explorer lives at <Link className="underline hover:text-text-secondary" href="/">/</Link>.
        </p>
      </div>
